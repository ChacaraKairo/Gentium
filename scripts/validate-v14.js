...
for (const key of [
  ...
  'bible.versionPicker.selectedOption',
  'bible.selection.count',
  'bible.selection.menu',
  'bible.selection.toggleVerse',
  'bible.originalLanguages.scriptLabel',
  'bible.originalLanguages.transliterationLabel',
  'bible.originalLanguages.pronunciationLabel',
  'bible.originalLanguages.traditionalNameLabel',
  'bible.originalLanguages.transliterationUnavailable',
  'bible.originalLanguages.pronunciationUnavailable',
  'bible.originalLanguages.traditionalNameUnavailable',
  'bible.originalLanguages.validatedOnlyNotice',
  'bible.originalLanguages.displayModes.title',
  'bible.originalLanguages.displayModes.original',
  'bible.originalLanguages.displayModes.transliteration',
  'bible.originalLanguages.displayModes.pronunciation',
  'bible.originalLanguages.displayModes.traditionalName',
  'bible.originalLanguages.displayModes.all',
  'donations.title',
  'donations.action',
